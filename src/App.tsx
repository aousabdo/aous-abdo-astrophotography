...
const photographs: Photograph[] = [
  ...
  { slug: 'spiral', title: 'Spiral, Alone', note: 'A whole island universe in one little frame.', src: asset('astro/spiral.jpg'), shape: 'tall', group: 'Galaxies' },
  ...
  { slug: 'stellar-dust', title: 'Stellar Dust', note: 'Every color was already there. The camera just waited.', src: asset('astro/stellar-dust.jpg'), shape: 'wide', group: 'Star fields' },
  ...
  { slug: 'cosmic-garden', title: 'Cosmic Garden', note: 'The sky getting a little carried away.', src: asset('astro/cosmic-garden.jpg'), shape: 'standard', group: 'Nebulae' },
  { slug: 'silver-island', title: 'Silver Island', note: 'One galaxy, floating past the noise.', src: asset('astro/silver-island.jpg'), shape: 'wide', group: 'Galaxies' },
  ...
  { slug: 'blue-hour', title: 'Blue Hour', note: 'The colder side of interstellar dust.', src: asset('astro/blue-hour.jpg'), shape: 'wide', group: 'Star fields' },
  { slug: 'red-emission', title: 'Red Emission', note: 'The long exposure found what my eyes could not.', src: asset('astro/red-emission.jpg'), shape: 'standard', group: 'Nebulae' },
  ...
  { slug: 'dark-dust', title: 'Dust Lane', note: 'The dark parts belong in the portrait too.', src: asset('astro/dark-dust.jpg'), shape: 'wide', group: 'Star fields' },
]
